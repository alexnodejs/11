...
////// Lighting:
                ...
                float3 finalColor = (_Tint.rgb*(_node_4840_copy.rgb*i.vertexColor.rgb));
                float2 node_1340 = (i.uv0+(node_4840.r*_MaskNoiseFactor));
                float4 _Mask_var = tex2D(_Mask,TRANSFORM_TEX(node_1340, _Mask));
                return fixed4(finalColor,(i.vertexColor.a*_Mask_var.r*saturate((sceneZ-partZ)/_DepthBlend)));
            }
            ENDCG
        }
    }
